      ...
      <Section className="section justify-center">
        <Card className="p-4 gap-2 max-lg:mt-20">
          ...
          <p className="mb-8">
            ...
            lieux répartis sur le quartier. Les points de collecte principaux
            sont approvisionnés prioritairement.
          </p>
          <div className="flex max-sm:flex-col-reverse max-sm:flex-col items-center max-sm:items-start mb-8">
            <div className="flex-[2] flex flex-col gap-2">
              <h3 className="text-lg mb-2 max-sm:mt-4">Points de collecte principaux</h3>
